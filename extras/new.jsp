...
try
{
	...
	{			
        ...
        fileOut.close();
 		...
 		if((ccode.equalsIgnoreCase("CS211")))
		{
			out.print("<pre>");
			out.print("\n\n\t\t\t<b>Student Name</b>\t\t:\t"+((String)session.getAttribute("name")));
			out.print("\n\t\t\t<b>Enrollment Number</b>\t:\t"+enrollno);
			out.print("\n\n");
			out.print("<b>\n\n\n\t\t\tCourse Code\t\t\t</b>");
			out.print("<b>Course Title\t\t\t</b>");
			out.print("<b>Attendance\t\t\t</b>");
			out.print("<b>Debarred<b>\n\n\n");
			out.print("\t\t\t"+ccode+"\t\t\t");
			out.print("\t"+ct);
		...
		if((ccode.equalsIgnoreCase("HSS201")))
		{
			out.print("<pre>");
			out.print("\t\t\t"+ccode+"\t\t\t");
			out.print("\t"+ct);
		...
		if((ccode.equalsIgnoreCase("CS301")))
		{
			out.print("<pre>");
			out.print("\t\t\t"+ccode+"\t\t\t");
			out.print("\t"+ct);
