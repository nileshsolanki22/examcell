...
<html lang="en">
	...
	<script language="javascript">
        ...
        <div class="container">
			...
			{
				response.sendRedirect("Debarlistt.jsp");
			}
			...
			%>	
			<iframe src="DebarStatust.jsp" width="1000px" height="500px" frameBorder="0" scrolling="yes" ></iframe>
			</div>
			
			<div class="footer">
			<a href="Debarlistt.jsp"><input type="button" value="back" class="button"></a>
			</div>						
