...
<html lang="en">
    ...
    <body>
        <div class="container">
			...
			Export <a href="temp/Invigilation.xls">Excel</a> &nbsp&nbsp <a href="temp/Invigilation.pdf" download>PDF</a>
			<iframe src="temp/Invigilation.pdf" width="1000px" height="450px" frameBorder="0" scrolling="no" ></iframe>
			<a href="Invigilation.jsp"><input type="button" value="back" class="button"></a>
			</div>
