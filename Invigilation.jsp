...
<html lang="en">
    ...
    <body>
        <div class="container">
			...
			<form action="InvigilationGenerate.jsp" name="myform" method="post" onsubmit="return validate(document.myform.batch.options[document.myform.batch.selectedIndex].value);" >
			<pre>
			Select Batch:
